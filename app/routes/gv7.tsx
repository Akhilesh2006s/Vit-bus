...
// VV1-specific data
const routeData = {
   title: "GV 7 Bus Route",
    description: "palakuluru to SGV",
    stops: [ "palakaluru","gujjana gundla current office","gujjana gundla","JKC college","RTO office road," ,"chillies","SGV"],
    schedule: [
      { time: "07:10 AM", status: "On Time" },
      { time: "07:20 AM", status: "On Time" },
      { time: "07:23 AM", status: "Delayed by 5m" },
      { time: "07:24 AM", status: "On Time" },
      { time: "07:25 AM", status: "On Time" },
      { time: "07:28 AM", status: "On Time" },
      { time: "07:29 AM", status: "On Time" },
