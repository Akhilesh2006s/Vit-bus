...
// VV1-specific data
const routeData = {
   title: "GV 5 Bus Route",
    description: "SVN colony to Syamala nagar petrol bunk",
    ...
    schedule: [
      ...
      { time: "07:21 AM", status: "On Time" },
      { time: "07:22 AM", status: "Delayed by 5m" },
      { time: "07:23 AM", status: "On Time" },
