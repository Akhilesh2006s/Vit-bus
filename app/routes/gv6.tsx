...
// VV1-specific data
const routeData = {
   title: "GV 6 Bus Route",
    description: "swamy theatre to auto nagar -guntur",
    stops: [ "swamy theatre","TJPS college","kankarakunta bridge","market","bus stand","auto nagar - guntur"],
    schedule: [
      { time: "07:26 AM", status: "On Time" },
      { time: "07:27 AM", status: "On Time" },
      { time: "07:38 AM", status: "Delayed by 5m" },
