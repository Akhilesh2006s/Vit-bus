...
// VV1-specific data
const routeData = {
   title: "GV 8 Bus Route",
    description: "vidhya nagar to kalamandir",
    ...
    schedule: [
      ...
      { time: "07:31 AM", status: "Delayed by 5m" },
      { time: "07:32 AM", status: "On Time" },
      { time: "07:33 AM", status: "On Time" },
      { time: "07:34 AM", status: "On Time" },
