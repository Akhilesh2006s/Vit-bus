...
const busRoutes = [
  ...
  { name: "VV7", city: "Guntur" },
  { name: "VV8", city: "Guntur" },
  { name: "VV9", city: "Guntur" },
  { name: "VV10", city: "Guntur" },
  { name: "VV11", city: "Guntur" },
  { name: "VV12", city: "Guntur" },
];
...
export default function BusRoutesScreen() {
  ...
  const handleSelectRoute = (busRoute: string) => {
    // Navigate to the route screen based on the bus route name
