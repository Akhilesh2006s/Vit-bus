...
const menuItems = [
  ...
  { icon: Globe, label: 'VTOP', color: '#3B82F6', action: 'vtop' }, // New VTOP item
...
export default function ProfilePage() {
  ...
  const handleMenuItemPress = async (action: string | undefined) => {
    ...
    } else if (action === 'vtop') { // Handle VTOP action
      Linking.openURL('https://vtop.vitap.ac.in/vtop/open/page'); // Open VTOP URL
    }
  };
  ...
  // Get email domain and route from user data
